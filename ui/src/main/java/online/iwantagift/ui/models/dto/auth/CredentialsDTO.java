...
public class CredentialsDTO {
    ...
    @NotBlank(message = "Email must not be blank", groups = {Default.class, ChangeEmail.class, ConfirmEmail.class})
    @Email(message = "Invalid email format", groups = {Default.class, ChangeEmail.class, ConfirmEmail.class})
